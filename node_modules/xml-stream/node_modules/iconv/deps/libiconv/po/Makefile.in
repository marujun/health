...
# ${SHELL} /Users/mrj/WebStormProject/project/health/node_modules/xml-stream/node_modules/iconv/deps/libiconv/build-aux/install-sh does not start with $(SHELL), so we add it.
# In automake >= 1.10, $(top_builddir)/build-aux/install-sh -c -d is derived from ${MKDIR_P}, which is defined
# either as "/path/to/mkdir -p" or ".../install-sh -c -d". For these automake
# versions, $(mkinstalldirs) and $(install_sh) are unused.
mkinstalldirs = $(SHELL) ${SHELL} /Users/mrj/WebStormProject/project/health/node_modules/xml-stream/node_modules/iconv/deps/libiconv/build-aux/install-sh -d
install_sh = $(SHELL) ${SHELL} /Users/mrj/WebStormProject/project/health/node_modules/xml-stream/node_modules/iconv/deps/libiconv/build-aux/install-sh
